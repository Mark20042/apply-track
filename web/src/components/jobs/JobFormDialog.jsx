...
export default function JobFormDialog({
    ...
    return (
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
            ...
            <DialogContent className="max-h-[85dvh] sm:max-h-[85vh] flex flex-col p-0 overflow-hidden sm:max-w-3xl bg-background shadow-2xl border-border/60">
                {/* Premium Header */}
                ...
                <form onSubmit={onSubmit} className="flex flex-col min-h-0">
                    ...
                    <div className="shrink-0 shrink bg-background px-3 sm:px-6 py-3 sm:py-4 border-t border-border/40 flex flex-col sm:flex-row gap-3">
                        {editingJob && (
